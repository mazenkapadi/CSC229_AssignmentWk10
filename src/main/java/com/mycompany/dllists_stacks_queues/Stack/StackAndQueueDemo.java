...
public class StackAndQueueDemo {
   public static void main(String[] args) {
      ...
      System.out.println("Is stack empty " + numStack.isEmpty());
      System.out.println("Stack size " + numStack.getSize());
      ...
      System.out.println("Is stack empty " + numQueue.isEmpty());
      System.out.println("Stack size " + numQueue.getSize());
